                ...
                {activeTab === 'bookings' && (
                    <div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 mb-3">
                            <div className="bg-white rounded-lg text-center p-3 shadow-sm border">
                                <div className="text-lg font-bold">{allBookings.length}</div>
                                <div className="text-xs text-gray-600">Total</div>
                            </div>
                            <div className="bg-white rounded-lg text-center p-3 shadow-sm border">
                                <div className="text-lg font-bold text-green-600">
                                    {allBookings.filter((b) => b.confirmedByDeveloper).length}
                                </div>
                        ...
                        {/* <div className="bg-white rounded-lg shadow-sm border p-3 mb-3">
                            <h3 className="text-sm font-semibold mb-2">Weekly Bookings Trend</h3>
