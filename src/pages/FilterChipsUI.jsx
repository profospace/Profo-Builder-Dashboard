                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        ...
                        <Card className="text-center">
                            ...
                            <CardContent className="text-2xl font-bold text-green-600">
                                {bookings.filter((b) => b.finalStatus === "CONFIRMED").length}
                            </CardContent>
                        </Card>
                        <Card className="text-center">
                            <CardHeader>
                            ...
                            <CardContent className="text-2xl font-bold text-yellow-600">
                                {bookings.filter((b) => b.finalStatus === "PENDING").length}
                            </CardContent>
                        </Card>
                    </div>
                                    ...
                                    <TableBody>
                                        {bookings.map((b) => (
                                            <TableRow key={b.id}>
                                                ...
                                                <TableCell className="font-semibold text-green-600">{b.token}</TableCell>
                                                <TableCell>{b.date}</TableCell>
                                                <TableCell>
                                                    <Badge variant="outline">{b.finalStatus}</Badge>
                                                </TableCell>
                ...
                <TabsContent value="analytics">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <Card className="text-center">
                            ...
                            <CardContent className="text-2xl font-bold">323</CardContent>
                        </Card>
                    </div>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <ResponsiveContainer width="100%" height={300}>
                                <BarChart data={properties}>
                                    <XAxis dataKey="title" hide={false} interval={0} angle={-15} textAnchor="end" height={60} />
                                    <YAxis />
                                    <Tooltip />
